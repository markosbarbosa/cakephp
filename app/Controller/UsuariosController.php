...
/**
 * http://localhost/admin/usuarios_index method
 *
 * @return void
 */
...
/**
 * http://localhost/admin/usuarios_view method
 *
 * @throws NotFoundException
 * @param string $id
 * @return void
 */
	public function usuarios_view($id = null) {
		if (!$this->Usuario->exists($id)) {
			throw new NotFoundException(__('Invalid usuario'));
		}
		$options = array('conditions' => array('Usuario.' . $this->Usuario->primaryKey => $id));
...
/**
 * http://localhost/admin/usuarios_add method
 *
 * @return void
 */
...
/**
 * http://localhost/admin/usuarios_edit method
 *
 * @throws NotFoundException
 * @param string $id
 * @return void
 */
	public function usuarios_edit($id = null) {
		if (!$this->Usuario->exists($id)) {
			throw new NotFoundException(__('Invalid usuario'));
		}
		if ($this->request->is(array('post', 'put'))) {
...
/**
 * http://localhost/admin/usuarios_delete method
 *
 * @throws NotFoundException
 * @param string $id
 * @return void
 */
	public function usuarios_delete($id = null) {
		$this->Usuario->id = $id;
		if (!$this->Usuario->exists()) {
			throw new NotFoundException(__('Invalid usuario'));
		}
